...
public $useTable = false;
	...
	'printing' => array(
		...
		'list'             => array(
			...
			array(
				'toc'   => 'Some Stuff Before You Start',
				'file'  => '',
				'alias' => '',
				'list'  => array(
					array(
			...
			array(
				...
				'list'  => array(
					...
					array(
						'toc'   => 'How to Use Balthisar’s Guide',
						'file'  => '02useinstruct',
						'alias' => 'use_instructions'
					),
					array(
						'toc'   => 'Scope/Background',
						'file'  => '03scopebackground',
						'alias' => 'scope_and_background'
					),
					array(
						'toc'   => 'A Couple of Terms and Caveats and Prerequisites and Stuff',
						'file'  => '05termscaveats',
						'alias' => 'terms_and_caveats'
					),
					array(
						'toc'   => 'What to Expect/Limitations',
						'file'  => '06whattoexpect',
			...
			array(
				'toc'   => 'Some Technical Stuff',
				'file'  => '',
				'alias' => '',
				'list'  => array(
					array(
						'toc'   => 'How Printers Print',
						'file'  => '10howprint',
						'alias' => 'how_printers_print'
					),
					array(
						'toc'   => 'Printing Under Classic Running in Mac OS X (already works!)',
						'file'  => '11printingunderclassic',
						'alias' => 'printing_under_classic'
					),
					array(
						'toc'   => 'Why (I think) Printing is Broken Under OS X',
						'file'  => '12whybroken',
						'alias' => 'why_broken'
					),
					array(
						'toc'   => 'An Interesting Experiment',
						'file'  => '13experiment',
						'alias' => 'experiment'
					),
					array(
						'toc'   => 'Technical Overview',
			...
			array(
				'toc'   => 'Print Scenarios (Getting Down to Business)',
				'file'  => '',
				'alias' => '',
				'list'  => array(
					array(
						'toc'   => 'Choose a Print Scenario',
						'file'  => '20scenarios',
			...
			array(
				'toc'   => 'Print Scenario 1',
				'file'  => '',
				'alias' => '',
				'list'  => array(
					array(
						'toc'   => 'Replace the Mac OS X 10.1.x LPRIOM.plugin file with that from 10.04',
						'file'  => '21replacelpriom',
						'alias' => 'scen1_replace_lpriom'
					),
					array(
						'toc'   => 'Install AFL-GhostScript 6.50.5',
						'file'  => '30installghostscript',
						'alias' => 'scen1_install_ghostscript'
					),
					array(
						'toc'   => 'Use NetInfo Manager to Define a Dummy Print Center Printer',
						'file'  => '22netinfodummy',
						'alias' => 'scen1_netinfo_dummy_printer'
					),
					array(
						'toc'   => 'Use NetInfo Manager to Define our “lp” Printer',
						'file'  => '23netinfolp',
						'alias' => 'scen1_netinfo_lp_printer'
					),
					array(
						'toc'   => 'Build Our Spool Directories',
						'file'  => '24buildspool',
						'alias' => 'scen1_build_spool'
					),
					array(
						'toc'   => 'Add Our Printer to the Print Center',
						'file'  => '25addprinters',
						'alias' => 'scen1_add_printers'
					),
					array(
						'toc'   => 'Use the Terminal to Build the Filter',
						'file'  => '26buildfilter',
						'alias' => 'scen1_build_filter'
					),
					array(
						'toc'   => 'About the Print Filter',
						'file'  => '27aboutfilter',
			...
			array(
				...
				'list'  => array(
					...
					array(
						'toc'   => 'Install SAMBA (SMB printers only)',
						'file'  => '31installsmb',
			...
			array(
				...
				'list'  => array(
					array(
						'toc'   => 'Hosting a Printer for Easy Setup',
						'file'  => '40hostingprinter',
						'alias' => 'hosting_printer'
					),
					array(
						'toc'   => 'Additional Printer Drivers',
						'file'  => '41includeddrivers',
						'alias' => 'additional_included_drivers'
					),
					array(
						'toc'   => 'HP Goodies for the 970',
						'file'  => '42hpgoodies',
						'alias' => 'hp_goodies'
					),
					array(
						'toc'   => 'Uniprint Drivers (*.upp files)',
						'file'  => '43uniprint',
						'alias' => 'uniprint'
					),
					array(
						'toc'   => 'gimp-print Drivers',
						'file'  => '44gimp-print',
						'alias' => 'gimp_print'
					),
					array(
						'toc'   => 'LPD seems to die: an AppleTalk/SAMBA Solution',
						'file'  => '45lpddies',
						'alias' => 'lp_dies'
					),
					array(
						'toc'   => 'localhost Printing',
					...
					array(
						'toc'   => 'Print to Print Server Computers',
						'file'  => '99notcoming',
						'alias' => 'print_to_server_pc'
					),
					array(
						'toc'   => 'Print Servers (Dedicated)',
						'file'  => '99notcoming',
			...
			array(
				...
				'list'  => array(
					...
					array(
						'toc'   => 'You Can Help Me and Others!',
						'file'  => '71help',
						'alias' => 'help_out'
					),
					array(
						'toc'   => 'Links and References',
						'file'  => '72linksreference',
						'alias' => 'links_and_references'
					),
					array(
						'toc'   => 'Document History',
						'file'  => '73history',
						'alias' => 'history',
					),
				)
			...
			array(
				'toc'   => 'Related Tutorials',
				'file'  => '',
				'alias' => '',
				'list'  => array(
					array(
						'toc'   => 'Start a Terminal Session',
					...
					array(
						'toc'   => 'Look at Error Log (Console)',
						'file'  => '82lookaterrorlog',
						'alias' => 'examine_error_log'
					),
					array(
						'toc'   => 'Move Around the File System',
						'file'  => '83movearound',
					...
					array(
						'toc'   => 'Generate Printer Test Files via Windows',
...
private $__flatList = array(); // built during construct.
	...
	/**---------------------------------------------------------------------------*
	 * Indicates whether or not `$alias` exists in `$book`
	 *
	 * @param  $alias   String of the alias name to check.
	 * @param  $book    String of the book name to check.
	 * @return boolean  true/false `$alias` exists in `$book`
	 * *---------------------------------------------------------------------------*/
	...
	/**---------------------------------------------------------------------------*
	 * Given a `$book` name, does it exist?
	 *
	 * @param     $book      String indicating the book to check.
	 * @return    boolean    Returns true if `$book` exists.
	 **---------------------------------------------------------------------------*/
	...
	/**---------------------------------------------------------------------------*
	 * Returns the complete relative path for the file for a given `$alias` in
	 * `$book`, or false if it does not exist.
	 *
	 * @param     $alias    String of the alias name to check.
	 * @param     $book     String of the book name to check.
	...
	/**---------------------------------------------------------------------------*
	 * Returns the path of the first page of `$book` or false if doesn‘t exist.
	 *
	 * @param     $book    String of the book name to check.
	 * @return             File path, or false.
	 **---------------------------------------------------------------------------*/
	...
	/**---------------------------------------------------------------------------*
	 * Indicates whether `$alias` is the toc page for `$book`.
	 *
	 * @param     $alias     String of the alias name to check.
	 * @param     $book      String of the book name to check.
	 * @return    boolean    True if `$alias` is the toc for `$book`.
	 **---------------------------------------------------------------------------*/
...
/// @{
	...
	/**---------------------------------------------------------------------------*
	 * Gets the data required to generate any of the styles of page navigator
	 * widgets using the helper.
	 *
	 * @param     $alias    String of the alias to retrieve data.
	 * @param     $book     String of the book to retrieve data.
	 * @return    mixed     Returns the array or false.
	...
	/**---------------------------------------------------------------------------*
	 * Build a data structure suitable for conversion into a `sitemap.xml` when
	 * applied to the right transformation, for the book `$book`.
	 *
	 * @param     $book    String of the book to retrieve data.
	 * @return    mixed    Returns the array or false.
	 **---------------------------------------------------------------------------*/
	...
	/**---------------------------------------------------------------------------*
	 * Build a data structure suitable for conversion into a table of contents
	 * when applied to the right transformation, for the book `$book`.
	 *
	 * @details
	 * Array remains nested to maintain nested \<ul> structure by    client;
	 * returns [text], [title], [href], and if applicable [children] nesting
	 * the above.
	 *
	 * @param     $book    String of the book to retrieve data.
	 * @return    mixed    Returns the array or false.
...
/// @}
	...
	/**---------------------------------------------------------------------------*
	 * Flattens the `$books` array so that we can hold it in memory.Data in the
	 * form of [book] => [tag] => [stuff] = {values}
	 *
	...
	/**---------------------------------------------------------------------------*
	 * For programmer friendliness many of the keys in the `$books` array are
	 * optional, but checking for their presence all the time is kind of a
	 * bummer. Called at instantiation this procedure will make sure every key
	 * is present even if as zero length strings.
	 *
	 * @param  array $srcArray A `$books` array, generally `$books`.
	 **---------------------------------------------------------------------------*/
	 ...
	 *
	 * @details
	 * Positive `$increment` will find the next (or later) key, and negative will
	 * find previous (or earlier) key. Will return false if they current key
	 * isn't found, or if the `$increment` goes beyond the bounds of the list.
	 *
	 * @param mixed $key       The current key
	 * @param array $hash      The list of all keys.
	 * @param mixed $increment Offset from current key desired.
	 * @return mixed           The desired key, or false if not possible.
	 **---------------------------------------------------------------------------*/
	 ...
	 *
	 * @param array $hash  The list of all keys.
	 * @return mixed       The first key in the list.
	 **---------------------------------------------------------------------------*/
	 ...
	 *
	 * @param array $hash  The list of all keys.
	 * @return mixed       The last key in the list.
	 **---------------------------------------------------------------------------*/
