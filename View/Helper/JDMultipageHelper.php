...
/**
    Implements a view helper to show navigation controls, tables
    of contents, or sitemap.xml bodies.
 */
...
/********************************************************************//**
    ...
    @details
        Returns the `$navData` in a series of `<divs>` (suitable for
        CSS styling) that contains links for First, Previous, TOC,
        Next, and Last pages.

    @param  $navData    The view's `$JDMPNavigatorData`.
    @retval string      HTML string for the navigator.
 ********************************************************************/
...
/********************************************************************//**
    ...
    @details
        Returns the `$navData` in a series of `<divs>` (suitable for
        CSS styling) that contains links for First, Previous, TOC,
        Next, and Last pages, and a five page mini index.
...
/********************************************************************//**
    ...
    @details
        Returns the `$navData` in a series of `<divs>` (suitable for
        CSS styling) that contains links for Previous, TOC, and
        Next pages.
...
/********************************************************************//**
	@brief Returns a sitemap.xml body for the specified $book.
        @param $book    The book for which the sitemap  is wanted.
        @retval String  String consisting of the TOC HTML.
 ********************************************************************/
...
/********************************************************************//**
	...
	@details
	    If you specifiy `$classes` it can consist of string, which
	    will be set as the class of the outer `<ul>` only, or as an
		...
		Everything else can be targetted very easily with careful
		CSS selectors.

	@param $book    The book for which the TOC is wanted.
	@param $classes String or Array as indicated above.
	@retval String  String consisting of the TOC HTML.
 ********************************************************************/
